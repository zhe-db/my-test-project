...
```
zhe-muc-bugbash        <- Root directory. Both monorepo and polyrepo are supported.
│
├── zhe_muc_bugbash       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
