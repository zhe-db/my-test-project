...
[ML Config](../zhe_muc_bugbash/resources/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore zhe_muc_bugbash/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. Verify that you're an admin by viewing the
  [staging workspace admin console](https://adb-5867961983879510.0.dev.azuredatabricks.net#setting/accounts) and
  [prod workspace admin console](https://adb-6249134709800315.5.dev.azuredatabricks.net#setting/accounts). If
...
Follow the instructions in [zhe-muc-bugbash/resources/README.md](../zhe_muc_bugbash/resources/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../zhe_muc_bugbash/resources/README.md)  to propose, test, and deploy
