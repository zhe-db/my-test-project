...
Opening a pull request will trigger a[workflow](../.github/workflows/zhe-muc-bugbash-run-tests.yml) 
...
* [Staging workspace registered model](https://adb-5867961983879510.0.dev.azuredatabricks.net#mlflow/models/staging-zhe-muc-bugbash-model)
* [Prod workspace registered model](https://adb-6249134709800315.5.dev.azuredatabricks.net#mlflow/models/prod-zhe-muc-bugbash-model)
